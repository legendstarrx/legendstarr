  ...
  return (
    <div className="pt-16 min-h-screen bg-black">
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        {/* Animated Background - pointer-events-none to not block scrolling */}
      ...
      <section className="py-16 bg-gray-900 relative overflow-hidden">
        {/* Background decoration - pointer-events-none to not block scrolling */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <AnimatedSection delay={0.1}>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-gold mb-4">You Apply</h3>
                <p className="text-gray-400">
                  Fill out a quick application form telling me about your business and goals. No commitment required.
                </p>
              </motion.div>
            </AnimatedSection>
          ...
          <AnimatedSection>
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-8">
                Fill out a quick form. I'll review and get back to you within 48 hours.
              </p>
